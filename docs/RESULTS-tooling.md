...
| `/tmp/schema-live-bp35-modelgate2.gb3jxP` | Full-history provisional-model gate | Opus 4.8, low, 5 turns, 5 actions, **$3.1545** | **0/9, 0.00% RHAE**; no completed level | Vendored scorer accepted; audit clean. Matched to the click-proposal run except for the model gate; contaminated dev game. |
